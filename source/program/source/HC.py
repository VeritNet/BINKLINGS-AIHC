...
px, py = 0, 0
cx, cy = 0, 0
cameraWidth, cameraHeight = read("C:/Program Files/BINKLINGS/BINKLINGS AIHC/cw"), read(
    "C:/Program Files/BINKLINGS/BINKLINGS AIHC/ch")
c = cv2.VideoCapture(read("C:/Program Files/BINKLINGS/BINKLINGS AIHC/camnum"))
c.set(3, cameraWidth)
c.set(4, cameraHeight)
screenWidth, screenHeight = autopy.screen.size()

minlength = read("C:/Program Files/BINKLINGS/BINKLINGS AIHC/ml")
print("init-success")
